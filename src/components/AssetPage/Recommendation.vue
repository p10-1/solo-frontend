<template>
  <section class="recommend-container">
    <h2 class="comment-title">
      "<span class="text-accent">{{ authStore.userInfo.userName }}</span>"님의 <span class="text-accent">자산 형성</span>을
      ...
      <div v-else class="recommend-contents">
        <dl class="comment-robot">
          ...
          <dd>
            ...
            <P class="comment">
              <b class="text-accent">{{ authStore.userInfo.userName }}</b>님이 가지고 계신 <b class="text-accent">대출</b>과
